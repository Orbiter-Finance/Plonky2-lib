...
pub trait CircuitBuilderRLP<F: RichField + Extendable<D>, const D: usize> {
    ...
    fn witness_subarray(
        ...
        array: &[U32Target],
        start_id: usize,
        start_id_target: &U32Target,
        sub_len: usize,
        sub_len_target: &U32Target,
        max_len: usize,
    ) -> Vec<U32Target>;
    ...
    fn parse_rlp_len(
        ...
        rlp_cells: &[U32Target],
        len_len: usize,
        len_len_target: U32Target,
        max_len: usize,
    ) -> (Vec<U32Target>, U32Target);
    ...
    for CircuitBuilder<F, D>
{
    ...
    fn parse_rlp_field_prefix(&mut self, prefix: &U32Target) -> RlpFieldPrefixParsed {
        ...
        let is_not_literal = self.is_less_than_u32(const_127, *prefix, num_bits);

        // if prefix < 184 => prefix in [128, 183], the string shouble be in 0-55 bytes long, the field length is prefix - 128
        let is_len_or_literal = self.is_less_than_u32(*prefix, const_184, num_bits);
